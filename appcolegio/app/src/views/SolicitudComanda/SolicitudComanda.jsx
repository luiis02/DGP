    ...
    const handleSearch = (query) => {
        ...
        if (query.trim() === "") {
            ...
            const filtered = alumnos.filter((alumno) =>
                (`${alumno.nombre} ${alumno.apellido}`.toLowerCase().includes(query.toLowerCase()))
            );
    ...
    return (
        <Layaout>
            ...
            <View style={styles.body}>
                    ...
                    <ScrollView>
                        {filteredAlumnos.map((alumno, index) => (
                            ...
                            >
                                ...
                                />
                                <Text style={{ fontSize: 16 }}>{alumno.nombre} {alumno.apellido}</Text>
                            </TouchableOpacity>
                        ))}
                    </ScrollView>
                    </View>
                ...
                <Text style={{ fontSize: 18, marginBottom: 10 }}>No hay alumnos disponibles.</Text>}
