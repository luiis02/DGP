...
import PantallaTareas from "./src/views/PantallaTareas/PantallaTareas";
import PantallaPasoTarea from "./src/views/PantallaPasoTarea/PantallaPasoTarea";
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen
          name="LoginProfesores"
          component={LoginProfesores}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="LoginAlumnos"
          component={LoginAlumnos}
          options={{ headerShown: false }}
        />
        ...
        <Stack.Screen
          name="DetallesProfesor"
          component={DetallesProfesor}
          options={{ headerShown: false }}
        />
        ...
        />
        <Stack.Screen
          name="InformacionMaterial"
          component={InformacionMaterial}
          options={{ headerShown: false }}
        />
        ...
        <Stack.Screen
          ...
          component={SolicitudMaterial}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="SolicitudMaterialAdmins"
          component={SolicitudMaterialAdmins}
          options={{ headerShown: false }}
        />

        <Stack.Screen
          name="SolicitudComanda"
          component={SolicitudComanda}
          options={{ headerShown: false }}
        />

        <Stack.Screen
          name="GenerarTareaMaterial"
          component={GenerarTareaMaterial}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="AgregarTarea"
        ...
        <Stack.Screen
          ...
          component={HistorialTareas}
          options={{ headerShown: false }}
        />

        <Stack.Screen
          name="InformeAlumno"
          component={InformeAlumno}
          options={{ headerShown: false }}
        />

        <Stack.Screen
          name="SeleccionarIcono"
          component={SeleccionarIcono}
          options={{ headerShown: false }}
        />

        <Stack.Screen
          name="TareaJuego"
          component={TareaJuego}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Inventario"
        ...
        <Stack.Screen
          name="Tasks"
          component={PantallaTareas}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Step"
          component={PantallaPasoTarea}
          options={{ headerShown: false }}
        />
      </Stack.Navigator>
    </NavigationContainer>
